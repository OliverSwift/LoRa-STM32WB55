...
I modified the [app_ble.c code](STM32_WPAN/App/app_ble.c) so the advertized (visible) name is based on STM32 UDN so you can distinguish two boards running at the same time.
